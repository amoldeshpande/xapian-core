...
int Xapian::InternalStemArmenian::r_mark_regions() { /* forwardmode */
    I_pV = l; /* $pV = <integer expression>, line 65 */
    I_p2 = l; /* $p2 = <integer expression>, line 66 */
    {   int c1 = c; /* do, line 67 */
        ...
        I_pV = c; /* setmark pV, line 68 */
        {    /* gopast */ /* non v, line 68 */
...
int Xapian::InternalStemArmenian::r_R2() { /* backwardmode */
    if (!(I_p2 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 75 */
    return 1;
}

int Xapian::InternalStemArmenian::r_adjective() { /* backwardmode */
    ket = c; /* [, line 78 */
    if (!(find_among_b(s_pool, a_0, 23, 0, 0))) return 0; /* substring, line 78 */
    bra = c; /* ], line 78 */
    if (slice_del() == -1) return -1; /* delete, line 103 */
    return 1;
}

int Xapian::InternalStemArmenian::r_verb() { /* backwardmode */
    ket = c; /* [, line 108 */
    if (!(find_among_b(s_pool, a_1, 71, 0, 0))) return 0; /* substring, line 108 */
    bra = c; /* ], line 108 */
    if (slice_del() == -1) return -1; /* delete, line 181 */
    return 1;
}

int Xapian::InternalStemArmenian::r_noun() { /* backwardmode */
    ket = c; /* [, line 186 */
    if (!(find_among_b(s_pool, a_2, 40, 0, 0))) return 0; /* substring, line 186 */
    bra = c; /* ], line 186 */
    if (slice_del() == -1) return -1; /* delete, line 228 */
    return 1;
}

int Xapian::InternalStemArmenian::r_ending() { /* backwardmode */
    ket = c; /* [, line 233 */
    if (!(find_among_b(s_pool, a_3, 57, 0, 0))) return 0; /* substring, line 233 */
    bra = c; /* ], line 233 */
    {   int ret = r_R2(); /* call R2, line 233 */
        if (ret <= 0) return ret;
    }
    if (slice_del() == -1) return -1; /* delete, line 292 */
    return 1;
}

int Xapian::InternalStemArmenian::stem() { /* forwardmode */
    /* do, line 299 */
    {   int ret = r_mark_regions(); /* call mark_regions, line 299 */
        if (ret == 0) goto lab0;
        if (ret < 0) return ret;
    }
lab0:
    lb = c; c = l; /* backwards, line 300 */


    {   int mlimit1; /* setlimit, line 300 */
        if (c < I_pV) return 0;
        mlimit1 = lb; lb = I_pV;
        {   int m2 = l - c; (void)m2; /* do, line 301 */
            {   int ret = r_ending(); /* call ending, line 301 */
                if (ret == 0) goto lab1;
                if (ret < 0) return ret;
            }
        lab1:
        ...
        {   int m3 = l - c; (void)m3; /* do, line 302 */
            {   int ret = r_verb(); /* call verb, line 302 */
                if (ret == 0) goto lab2;
                if (ret < 0) return ret;
            }
        lab2:
        ...
        {   int m4 = l - c; (void)m4; /* do, line 303 */
            {   int ret = r_adjective(); /* call adjective, line 303 */
                if (ret == 0) goto lab3;
                if (ret < 0) return ret;
            }
        lab3:
        ...
        {   int m5 = l - c; (void)m5; /* do, line 304 */
            {   int ret = r_noun(); /* call noun, line 304 */
                if (ret == 0) goto lab4;
                if (ret < 0) return ret;
            }
        lab4:
