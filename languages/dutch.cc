...
int Xapian::InternalStemDutch::r_mark_regions() { /* forwardmode */
    ...
    /* try, line 72 */
    if (!(I_p1 < 3)) goto lab0; /* $(<integer expression> < <integer expression>), line 72 */
...
int Xapian::InternalStemDutch::r_R1() { /* backwardmode */
    if (!(I_p1 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 89 */
    return 1;
}

int Xapian::InternalStemDutch::r_R2() { /* backwardmode */
    if (!(I_p2 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 90 */
    return 1;
}
