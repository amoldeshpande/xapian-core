...
int Xapian::InternalStemFrench::r_RV() { /* backwardmode */
    if (!(I_pV <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 89 */
    return 1;
}

int Xapian::InternalStemFrench::r_R1() { /* backwardmode */
    if (!(I_p1 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 90 */
    return 1;
}

int Xapian::InternalStemFrench::r_R2() { /* backwardmode */
    if (!(I_p2 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 91 */
    return 1;
}
...
lab1:
    ...
    {   int m2 = l - c; (void)m2; /* do, line 229 */
        {   int m3 = l - c; (void)m3; /* or, line 239 */
            {   int m4 = l - c; (void)m4; /* and, line 235 */
                {   int m5 = l - c; (void)m5; /* or, line 231 */
            ...
            lab5:
                c = l - m4;
                {   int m6 = l - c; (void)m6; /* try, line 236 */
                    ket = c; /* [, line 236 */
                    {   int m7 = l - c; (void)m7; /* or, line 236 */
                    ...
                    lab10:
                        c = l - m7;
                        if (!(eq_s_b(2, s_32))) { c = l - m6; goto lab8; } /* literal, line 237 */
                        bra = c; /* ], line 237 */
    ...
    {   int m8 = l - c; (void)m8; /* do, line 245 */
    ...
    {   int m9 = l - c; (void)m9; /* do, line 246 */
