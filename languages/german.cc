...
int Xapian::InternalStemGerman::r_mark_regions() { /* forwardmode */
    ...
    /* try, line 56 */
    if (!(I_p1 < I_x)) goto lab0; /* $(<integer expression> < <integer expression>), line 56 */
...
int Xapian::InternalStemGerman::r_R1() { /* backwardmode */
    if (!(I_p1 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 76 */
    return 1;
}

int Xapian::InternalStemGerman::r_R2() { /* backwardmode */
    if (!(I_p2 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 77 */
    return 1;
}
        ...
        switch (among_var) { /* among, line 81 */
            ...
            case 2:
                ...
                {   int m2 = l - c; (void)m2; /* try, line 87 */
                    ...
                    c--;
                    bra = c; /* ], line 87 */
                    if (!(eq_s_b(3, s_8))) { c = l - m2; goto lab1; } /* literal, line 87 */
        ...
        switch (among_var) { /* among, line 105 */
            case 1:
                ...
                {   int m5 = l - c; (void)m5; /* try, line 108 */
                    ket = c; /* [, line 108 */
                    if (!(eq_s_b(2, s_9))) { c = l - m5; goto lab4; } /* literal, line 108 */
                    bra = c; /* ], line 108 */
            ...
            case 3:
                ...
                {   int m8 = l - c; (void)m8; /* try, line 115 */
                    ...
                    {   int m9 = l - c; (void)m9; /* or, line 116 */
                        if (!(eq_s_b(2, s_10))) goto lab9; /* literal, line 116 */
                        goto lab8;
                    lab9:
                        c = l - m9;
                        if (!(eq_s_b(2, s_11))) { c = l - m8; goto lab7; } /* literal, line 116 */
                    }
                lab8:
                    bra = c; /* ], line 116 */
