...
int Xapian::InternalStemGerman2::r_mark_regions() { /* forwardmode */
    ...
    /* try, line 62 */
    if (!(I_p1 < I_x)) goto lab0; /* $(<integer expression> < <integer expression>), line 62 */
...
int Xapian::InternalStemGerman2::r_R1() { /* backwardmode */
    if (!(I_p1 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 82 */
    return 1;
}

int Xapian::InternalStemGerman2::r_R2() { /* backwardmode */
    if (!(I_p2 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 83 */
    return 1;
}
        ...
        switch (among_var) { /* among, line 87 */
            ...
            case 2:
                ...
                {   int m2 = l - c; (void)m2; /* try, line 93 */
                    ...
                    c--;
                    bra = c; /* ], line 93 */
                    if (!(eq_s_b(3, s_10))) { c = l - m2; goto lab1; } /* literal, line 93 */
        ...
        switch (among_var) { /* among, line 111 */
            case 1:
                ...
                {   int m5 = l - c; (void)m5; /* try, line 114 */
                    ket = c; /* [, line 114 */
                    if (!(eq_s_b(2, s_11))) { c = l - m5; goto lab4; } /* literal, line 114 */
                    bra = c; /* ], line 114 */
            ...
            case 3:
                ...
                {   int m8 = l - c; (void)m8; /* try, line 121 */
                    ...
                    {   int m9 = l - c; (void)m9; /* or, line 122 */
                        if (!(eq_s_b(2, s_12))) goto lab9; /* literal, line 122 */
                        goto lab8;
                    lab9:
                        c = l - m9;
                        if (!(eq_s_b(2, s_13))) { c = l - m8; goto lab7; } /* literal, line 122 */
                    }
                lab8:
                    bra = c; /* ], line 122 */
