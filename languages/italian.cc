...
int Xapian::InternalStemItalian::r_RV() { /* backwardmode */
    if (!(I_pV <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 83 */
    return 1;
}

int Xapian::InternalStemItalian::r_R1() { /* backwardmode */
    if (!(I_p1 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 84 */
    return 1;
}

int Xapian::InternalStemItalian::r_R2() { /* backwardmode */
    if (!(I_p2 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 85 */
    return 1;
}
    ...
    switch (among_var) { /* among, line 105 */
        ...
        case 8:
            ...
            {   int m3 = l - c; (void)m3; /* try, line 136 */
                ...
                if (!(find_among_b(s_pool, a_5, 3, 0, 0))) { c = l - m3; goto lab2; }
                bra = c; /* ], line 137 */
...
int Xapian::InternalStemItalian::r_verb_suffix() { /* backwardmode */
    ...
    {   int mlimit1; /* setlimit, line 149 */
        ...
        mlimit1 = lb; lb = I_pV;
        ket = c; /* [, line 150 */
        if (!(find_among_b(s_pool, a_7, 87, 0, 0))) { lb = mlimit1; return 0; } /* substring, line 150 */
        bra = c; /* ], line 150 */
...
lab1:
    ...
    {   int m2 = l - c; (void)m2; /* do, line 186 */
    ...
    {   int m3 = l - c; (void)m3; /* do, line 187 */
        {   int m4 = l - c; (void)m4; /* or, line 187 */
    ...
    {   int m5 = l - c; (void)m5; /* do, line 188 */
