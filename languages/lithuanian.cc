...
int Xapian::InternalStemLithuanian::r_R1() { /* backwardmode */
    if (!(I_p1 <= c)) return 0; /* $(<integer expression> <= <integer expression>), line 45 */
    return 1;
}

int Xapian::InternalStemLithuanian::r_step1() { /* backwardmode */

    {   int mlimit1; /* setlimit, line 47 */
        if (c < I_p1) return 0;
        mlimit1 = lb; lb = I_p1;
        ket = c; /* [, line 47 */
        if (!(find_among_b(s_pool, a_0, 204, 0, 0))) { lb = mlimit1; return 0; } /* substring, line 47 */
        bra = c; /* ], line 47 */
        lb = mlimit1;
    }
    {   int ret = r_R1(); /* call R1, line 47 */
        if (ret <= 0) return ret;
    }
    if (slice_del() == -1) return -1; /* delete, line 231 */
    return 1;
}

int Xapian::InternalStemLithuanian::r_step2() { /* backwardmode */
    while(1) { /* repeat, line 234 */
        int m1 = l - c; (void)m1;

        {   int mlimit2; /* setlimit, line 235 */
            if (c < I_p1) goto lab0;
            mlimit2 = lb; lb = I_p1;
            ket = c; /* [, line 235 */
            if (!(find_among_b(s_pool, a_1, 62, 0, 0))) { lb = mlimit2; goto lab0; } /* substring, line 235 */
            bra = c; /* ], line 235 */
            lb = mlimit2;
        }
        if (slice_del() == -1) return -1; /* delete, line 305 */
        continue;
    lab0:
        c = l - m1;
        break;
...
int Xapian::InternalStemLithuanian::r_fix_conflicts() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 309 */
    if (c - 3 <= lb || p[c - 1] >> 5 != 3 || !((2621472 >> (p[c - 1] & 0x1f)) & 1)) return 0; /* substring, line 309 */
    among_var = find_among_b(s_pool, a_2, 11, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 309 */
    switch (among_var) { /* among, line 309 */
        case 1:
            {   int ret = slice_from_s(5, s_0); /* <-, line 311 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(5, s_1); /* <-, line 316 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(7, s_2); /* <-, line 321 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(4, s_3); /* <-, line 324 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            {   int ret = slice_from_s(4, s_4); /* <-, line 326 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = slice_from_s(6, s_5); /* <-, line 329 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            {   int ret = slice_from_s(6, s_6); /* <-, line 330 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   int ret = slice_from_s(6, s_7); /* <-, line 333 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemLithuanian::r_fix_chdz() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 340 */
    if (c - 1 <= lb || (p[c - 1] != 141 && p[c - 1] != 190)) return 0; /* substring, line 340 */
    among_var = find_among_b(s_pool, a_3, 2, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 340 */
    switch (among_var) { /* among, line 340 */
        case 1:
            {   int ret = slice_from_s(1, s_8); /* <-, line 341 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(1, s_9); /* <-, line 342 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemLithuanian::r_fix_gd() { /* backwardmode */
    ket = c; /* [, line 347 */
    if (c - 1 <= lb || p[c - 1] != 100) return 0; /* substring, line 347 */
    if (!(find_among_b(s_pool, a_4, 1, 0, 0))) return 0;
    bra = c; /* ], line 347 */
    {   int ret = slice_from_s(1, s_10); /* <-, line 348 */
        if (ret < 0) return ret;
    }
    return 1;
}

int Xapian::InternalStemLithuanian::stem() { /* forwardmode */
    I_p1 = l; /* $p1 = <integer expression>, line 357 */
    {   int c1 = c; /* do, line 359 */
        {   int c2 = c; /* try, line 361 */
            {   int c_test3 = c; /* test, line 361 */
                if (c == l || p[c] != 'a') { c = c2; goto lab1; } /* literal, line 361 */
                c++;
                c = c_test3;
            }
            if (!(len_utf8(p) > 6)) { c = c2; goto lab1; } /* $(<integer expression> > <integer expression>), line 361 */
            {   int ret = skip_utf8(p, c, 0, l, + 1); /* hop, line 361 */
        ...
        {    /* gopast */ /* grouping v, line 363 */
            int ret = out_grouping_U(g_v, 97, 371, 1);
            if (ret < 0) goto lab0;
            c += ret;
        }
        {    /* gopast */ /* non v, line 363 */
            int ret = in_grouping_U(g_v, 97, 371, 1);
            if (ret < 0) goto lab0;
            c += ret;
        }
        I_p1 = c; /* setmark p1, line 363 */
    lab0:
        c = c1;
    }
    lb = c; c = l; /* backwards, line 366 */

    {   int m4 = l - c; (void)m4; /* do, line 367 */
        {   int ret = r_fix_conflicts(); /* call fix_conflicts, line 367 */
            if (ret == 0) goto lab2;
            if (ret < 0) return ret;
        }
    lab2:
    ...
    {   int m5 = l - c; (void)m5; /* do, line 368 */
        {   int ret = r_step1(); /* call step1, line 368 */
            if (ret == 0) goto lab3;
            if (ret < 0) return ret;
        }
    lab3:
    ...
    {   int m6 = l - c; (void)m6; /* do, line 369 */
        {   int ret = r_fix_chdz(); /* call fix_chdz, line 369 */
            if (ret == 0) goto lab4;
            if (ret < 0) return ret;
        }
    lab4:
    ...
    {   int m7 = l - c; (void)m7; /* do, line 370 */
        {   int ret = r_step2(); /* call step2, line 370 */
            if (ret == 0) goto lab5;
            if (ret < 0) return ret;
        }
    lab5:
    ...
    {   int m8 = l - c; (void)m8; /* do, line 371 */
        {   int ret = r_fix_chdz(); /* call fix_chdz, line 371 */
            if (ret == 0) goto lab6;
            if (ret < 0) return ret;
        }
    lab6:
    ...
    {   int m9 = l - c; (void)m9; /* do, line 372 */
        {   int ret = r_fix_gd(); /* call fix_gd, line 372 */
            if (ret == 0) goto lab7;
            if (ret < 0) return ret;
        }
    lab7:
