...
int Xapian::InternalStemNepali::r_remove_category_1() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 56 */
    among_var = find_among_b(s_pool, a_0, 17, 0, 0); /* substring, line 56 */
    ...
    switch (among_var) { /* among, line 56 */
        case 1:
            ...
            break;
        case 2:
            {   int m1 = l - c; (void)m1; /* or, line 61 */
                {   int m2 = l - c; (void)m2; /* or, line 61 */
                    if (!(eq_s_b(3, s_0))) goto lab3; /* literal, line 61 */
                    goto lab2;
                lab3:
                    c = l - m2;
                    if (!(eq_s_b(3, s_1))) goto lab1; /* literal, line 61 */
                }
            lab2:
                goto lab0;
            lab1:
...
int Xapian::InternalStemNepali::r_check_category_2() { /* backwardmode */
    ket = c; /* [, line 66 */
    if (c - 2 <= lb || p[c - 1] >> 5 != 4 || !((262 >> (p[c - 1] & 0x1f)) & 1)) return 0; /* substring, line 66 */
    if (!(find_among_b(s_pool, a_1, 3, 0, 0))) return 0;
    bra = c; /* ], line 66 */
    return 1;
}

int Xapian::InternalStemNepali::r_remove_category_2() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 72 */
    if (c - 2 <= lb || p[c - 1] >> 5 != 4 || !((262 >> (p[c - 1] & 0x1f)) & 1)) return 0; /* substring, line 72 */
    among_var = find_among_b(s_pool, a_2, 3, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 72 */
    switch (among_var) { /* among, line 72 */
        case 1:
            {   int m1 = l - c; (void)m1; /* or, line 73 */
                if (!(eq_s_b(6, s_2))) goto lab1; /* literal, line 73 */
                goto lab0;
            lab1:
                c = l - m1;
                if (!(eq_s_b(6, s_3))) goto lab2; /* literal, line 73 */
                goto lab0;
            lab2:
                c = l - m1;
                if (!(eq_s_b(6, s_4))) goto lab3; /* literal, line 73 */
                goto lab0;
            lab3:
                c = l - m1;
                if (!(eq_s_b(6, s_5))) return 0; /* literal, line 73 */
            }
        lab0:
            if (slice_del() == -1) return -1; /* delete, line 73 */
            break;
        case 2:
            if (!(eq_s_b(9, s_6))) return 0; /* literal, line 74 */
...
int Xapian::InternalStemNepali::r_remove_category_3() { /* backwardmode */
    ket = c; /* [, line 79 */
    if (!(find_among_b(s_pool, a_3, 91, 0, 0))) return 0; /* substring, line 79 */
    bra = c; /* ], line 79 */
    if (slice_del() == -1) return -1; /* delete, line 81 */
    return 1;
}

int Xapian::InternalStemNepali::stem() { /* forwardmode */
    lb = c; c = l; /* backwards, line 88 */

    {   int m1 = l - c; (void)m1; /* do, line 89 */
        {   int ret = r_remove_category_1(); /* call remove_category_1, line 89 */
            if (ret == 0) goto lab0;
            if (ret < 0) return ret;
        }
    lab0:
    ...
    {   int m2 = l - c; (void)m2; /* do, line 90 */
        while(1) { /* repeat, line 91 */
            int m3 = l - c; (void)m3;
            {   int m4 = l - c; (void)m4; /* do, line 91 */
                {   int m5 = l - c; (void)m5; /* and, line 91 */
                    {   int ret = r_check_category_2(); /* call check_category_2, line 91 */
                        if (ret == 0) goto lab3;
                        if (ret < 0) return ret;
                    }
                    c = l - m5;
                    {   int ret = r_remove_category_2(); /* call remove_category_2, line 91 */
                        if (ret == 0) goto lab3;
                        if (ret < 0) return ret;
                    }
                }
            ...
            {   int ret = r_remove_category_3(); /* call remove_category_3, line 91 */
                if (ret == 0) goto lab2;
                if (ret < 0) return ret;
            }
            continue;
