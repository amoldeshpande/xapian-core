...
int Xapian::InternalStemPorter::r_Step_2() { /* backwardmode */
    ...
    switch (among_var) { /* among, line 60 */
        ...
        case 9:
            ...
            break;
        case 10:
            {   int ret = slice_from_s(3, s_15); /* <-, line 74 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret = slice_from_s(3, s_16); /* <-, line 76 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
            {   int ret = slice_from_s(3, s_17); /* <-, line 78 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
            {   int ret = slice_from_s(3, s_18); /* <-, line 79 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemPorter::r_Step_3() { /* backwardmode */
    ...
    switch (among_var) { /* among, line 84 */
        case 1:
            {   int ret = slice_from_s(2, s_19); /* <-, line 85 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(2, s_20); /* <-, line 87 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
...
int Xapian::InternalStemPorter::stem() { /* forwardmode */
    ...
    {   int c1 = c; /* do, line 118 */
        ...
        c++;
        ket = c; /* ], line 118 */
        {   int ret = slice_from_s(1, s_21); /* <-, line 118 */
            if (ret < 0) return ret;
        }
    ...
    {   int c2 = c; /* do, line 119 */
        while(1) { /* repeat, line 119 */
            ...
            {   int ret = slice_from_s(1, s_22); /* <-, line 119 */
                if (ret < 0) return ret;
            }
    ...
    {   int c14 = c; /* do, line 139 */
        ...
        while(1) { /* repeat, line 139 */
            ...
            {   int ret = slice_from_s(1, s_23); /* <-, line 139 */
                if (ret < 0) return ret;
            }
            continue;
        lab14:
