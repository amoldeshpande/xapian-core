...
int Xapian::InternalStemRussian::r_adjective() { /* backwardmode */
    ket = c; /* [, line 90 */
    if (!(find_among_b(s_pool, a_1, 26, 0, 0))) return 0; /* substring, line 90 */
    bra = c; /* ], line 90 */
...
int Xapian::InternalStemRussian::r_noun() { /* backwardmode */
    ket = c; /* [, line 162 */
    if (!(find_among_b(s_pool, a_5, 36, 0, 0))) return 0; /* substring, line 162 */
    bra = c; /* ], line 162 */
...
lab0:
    ...
    {   int mlimit1; /* setlimit, line 204 */
        if (c < I_pV) return 0;
        mlimit1 = lb; lb = I_pV;
        {   int m2 = l - c; (void)m2; /* do, line 205 */
            {   int m3 = l - c; (void)m3; /* or, line 206 */
            ...
            lab3:
                c = l - m3;
                {   int m4 = l - c; (void)m4; /* try, line 207 */
                    {   int ret = r_reflexive(); /* call reflexive, line 207 */
                        if (ret == 0) { c = l - m4; goto lab4; }
                        if (ret < 0) return ret;
                    }
                lab4:
                    ;
        ...
        {   int m6 = l - c; (void)m6; /* try, line 211 */
            ket = c; /* [, line 211 */
            if (!(eq_s_b(2, s_9))) { c = l - m6; goto lab8; } /* literal, line 211 */
            bra = c; /* ], line 211 */
            if (slice_del() == -1) return -1; /* delete, line 211 */
        lab8:
            ;
        }
        {   int m7 = l - c; (void)m7; /* do, line 214 */
        ...
        {   int m8 = l - c; (void)m8; /* do, line 215 */
